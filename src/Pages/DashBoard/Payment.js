...
const Payment = () => {
    ...
    const url = `https://jantrik-carpentary-tools-server-side.vercel.app/order/${orderId}`;
    ...
    return (
        <div>
            <div className="card w-[90%] mx-auto lg:w-96 lg:mx-0 bg-base-100 shadow-xl my-6">
            ...
            <div className="card w-[90%] mx-auto lg:w-96 lg:mx-0 bg-base-100 shadow-xl">
                <div className="card-body">

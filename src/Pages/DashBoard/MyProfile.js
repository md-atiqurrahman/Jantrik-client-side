...
const MyProfile = () => {
    ...
    const { data: profile } = useQuery(['profile', user], () => fetch(`https://jantrik-server-side.up.railway.app/userProfile?email=${user?.email}`, {
        method: 'GET',
        headers: {
    ...
    const onSubmit = async (data) => {
        if (data?.save) {
            ...
            fetch('https://jantrik-server-side.up.railway.app/userProfile', {
                method: 'POST',
                headers: {
        ...
        if (data?.update) {
            ...
            fetch(`https://jantrik-server-side.up.railway.app/userProfile/${data.email}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    authorization: `Bearer ${localStorage.getItem('accessToken')}`

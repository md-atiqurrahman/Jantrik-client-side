...
const ManageProducts = () => {
    ...
    const { data: tools, isLoading, refetch } = useQuery(['tools',user], () => fetch('https://jantrik-server-side.up.railway.app/tools').then(res => res.json()))
    ...
    const handleDeleteTools = (id) => {
        fetch(`https://jantrik-server-side.up.railway.app/tool/${id}`, {
            method: 'DELETE',
            headers: {

...
const BestSellerProducts = () => {
    return (
        <div className='lg:mx-[90px] mb-[50px]'>
            <div className='flex justify-between border border-[#dddddd] py-[10px] pl-[25px] pr-[10px] mb-[4px] section-title'>
                <div>
            ...
            <div className='w-[80%] lg:w-full mx-auto '>
                <div className='border-b-0 lg:border-b'>
                ...
                <div className='mt-[5px]'>
                    <div className='flex justify-between flex-col lg:flex-row'>
                        ...
                        <div className='hidden lg:flex justify-center items-center '>
                            <div className='text-center border-r border-[#dddddd] h-[75px] -ml-[10px]'>
                            </div>
                        </div>
                        <div className='flex py-[25px] px-[15px]'>
                            <div className='mr-[8px]'>
                            ...
                            <div>
                                ...
                                <p className='title text-[14px] font-medium  mb-[5px]'>Revolt E.9V Jigsaw</p>
                                <p className='title text-[14px]  font-medium'>Price: $139.00</p>
                            </div>
                        </div>
                        <div className='hidden lg:flex justify-center items-center -mr-[4px]'>
                            <div className='text-center border-r border-[#dddddd] h-[75px]'>
                            </div>
                        </div>
                        <div className='flex py-[25px] px-[15px]'>
